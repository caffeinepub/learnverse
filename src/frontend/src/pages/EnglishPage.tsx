...
const englishDataTr: Record<Level, EngItem[]> = {
  okul_oncesi: [
    {
      key: "eng_colors",
      emoji: "🌈",
    ...
    },
    {
      ...
      description:
        "Merhaba, Güle güle, Teşekkürler — Hello, Goodbye, Thank you",
    ...
    },
    {
      ...
      description:
        "Otobüs, Araba, Uçak, Bisiklet — Bus, Car, Airplane, Bicycle",
  ...
  ilkokul: [
    {
      ...
      title: "Okul / School",
      description:
        "Okul, Öğretmen, Kitap, Kalem — School, Teacher, Book, Pencil",
    ...
    },
    {
      ...
      title: "Günler / Days",
      description:
        "Pazartesi...Pazar — Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday",
    ...
    },
    {
      ...
      title: "Aylar / Months",
      description:
        "Ocak, Şubat, Mart... — January, February, March, April, May, June",
    ...
    },
    {
      ...
      description:
        "Okumak, Oynamak, Yüzmek — Reading, Playing, Swimming, Drawing",
    ...
    },
    {
      ...
      title: "Ev / Home",
      description:
        "Mutfak, Salon, Banyo, Yatak Odası — Kitchen, Living room, Bathroom, Bedroom",
    ...
    },
    {
      ...
      title: "Spor / Sports",
      description:
        "Futbol, Yüzme, Koşu, Tenis — Football, Swimming, Running, Tennis",
      example:
        "I play football on Saturdays. (Cumartesi günleri futbol oynuyorum.)",
    },
    {
      ...
      description:
        "Üzerinde, Altında, İçinde, Yanında — On, Under, In, Next to, Behind",
    ...
    },
    {
      ...
      description:
        "Doktor, Öğretmen, Polis, Mühendis — Doctor, Teacher, Police Officer, Engineer",
    ...
    },
    {
      ...
      title: "Yerler / Places",
      description:
        "Market, Hastane, Okul, Park — Supermarket, Hospital, School, Park",
    ...
    },
    {
      ...
      example:
        "There are twenty students in my class. (Sınıfımda yirmi öğrenci var.)",
    },
  ],
  ortaokul: [
    {
      ...
      description:
        "Geçmiş zaman '-di/-ti' eki — I played / She went / They saw",
    ...
    },
    {
      ...
      description:
        "Süregelen eylemler için kullanılır — I am playing / She is reading",
    ...
    },
    {
      ...
      description:
        "Gelecekteki eylemler için 'will' kullanılır — I will go / They will see",
    ...
    },
    {
      ...
      description:
        "Çevre, iklim, kirlilik, geri dönüşüm — Pollution, Recycling, Climate, Nature",
    ...
    },
    {
      ...
      description:
        "Bilgisayar, internet, uygulama — Computer, Internet, Application, Smartphone",
      example:
    ...
    },
    {
      ...
      title: "Sağlık / Health",
      description:
        "Hasta, Doktor, İlaç, Ameliyat — Sick, Doctor, Medicine, Surgery",
    ...
    },
    {
      ...
      description:
        "Daha büyük, en büyük — Bigger, Biggest / More interesting, Most interesting",
    ...
    },
    {
      ...
      description:
        "Özür dilerim, Lütfen, Rica ederim — I'm sorry, Please, You're welcome, Excuse me",
      example:
        "Excuse me, where is the library? (Affedersiniz, kütüphane nerede?)",
    },
    {
      key: "eng_modal",
      emoji: "🔧",
      ...
      description:
        "Yapabilmek, Yapmak zorunda, Yapmalı — Can, Must, Should, Would, Could",
    ...
    },
    {
      ...
      description:
        "Kim, Ne, Nerede, Ne zaman, Neden, Nasıl — Who, What, Where, When, Why, How",
    ...
    },
    {
      ...
      description:
        "Tanışma, Alışveriş, Yol Sorma — Nice to meet you. How much is it? Turn left.",
      example:
        "A: How are you? B: I'm fine, thank you. (Nasılsın? İyiyim, teşekkürler.)",
    },
    {
      key: "eng_passive",
      emoji: "🔄",
      ...
      description:
        "Yapılmak, Yıkanmak, Yazılmak — is made, was written, will be done",
    ...
    },
    {
      ...
      description:
        "Ve, Ama, Çünkü, Dolayısıyla — And, But, Because, However, Therefore",
      example:
        "I studied hard, therefore I passed the exam. (Çok çalıştım, bu yüzden sınavı geçtim.)",
    },
  ],
};

const englishDataEn: Record<Level, EngItem[]> = {
  okul_oncesi: [
    {
      key: "eng_colors",
      emoji: "🌈",
      title: "Colors",
      description:
        "Learn your first colors: Red, Blue, Yellow, Green, Purple, Orange",
    ...
    },
    {
      ...
      title: "Animals",
      description:
        "Common animals: Dog, Cat, Bird, Fish, Rabbit, Lion, Elephant",
    ...
    },
    {
      ...
      title: "Family",
      description:
        "Family words: Mother, Father, Brother, Sister, Grandmother, Grandfather",
    ...
    },
    {
      ...
      title: "Greetings",
      description:
        "Say hello: Hello, Hi, Good morning, Goodbye, Thank you, Please",
    ...
    },
    {
      ...
      title: "Fruits",
      description:
        "Colourful fruits: Apple, Banana, Strawberry, Grape, Orange, Mango",
    ...
    },
    {
      ...
      title: "Nature",
      description:
        "Outside world: Flower, Tree, Sun, Star, Moon, River, Mountain",
  ...
  ilkokul: [
    {
      ...
      title: "School",
      description:
        "At school you find: Teacher, Book, Pencil, Desk, Classroom, Homework",
    ...
    },
    {
      ...
      title: "Weather",
      description:
        "Describe the weather: Sunny, Rainy, Snowy, Cloudy, Windy, Foggy",
    ...
    },
    {
      ...
      title: "Months",
      description:
        "Twelve months: January, February, March, April, May, June, July, August...",
    ...
    },
    {
      ...
      title: "Hobbies",
      description:
        "Fun activities: Reading, Playing, Swimming, Drawing, Singing, Dancing",
    ...
    },
    {
      ...
      title: "At Home",
      description:
        "Rooms at home: Kitchen, Living room, Bathroom, Bedroom, Garden, Hallway",
    ...
    },
    {
      ...
      title: "Clothes",
      description:
        "What to wear: Shirt, Pants, Shoes, Hat, Dress, Jacket, Socks",
    ...
    },
    {
      ...
      title: "Action Verbs",
      description:
        "Action words: Run, Sit, Eat, Sleep, Walk, Jump, Read, Write, Swim",
    ...
    },
    {
      ...
      title: "Adjectives",
      description:
        "Describing words: Big, Small, Fast, Old, New, Beautiful, Funny, Brave",
    ...
    },
    {
      ...
      title: "Sports",
      description:
        "Popular sports: Football, Swimming, Running, Tennis, Basketball, Volleyball",
    ...
    },
    {
      ...
      title: "Prepositions",
      description:
        "Position words: On, Under, In, Next to, Behind, In front of, Between",
    ...
    },
    {
      ...
      title: "Time",
      description:
        "Parts of the day: Morning, Noon, Afternoon, Evening, Night, Midnight",
    ...
    },
    {
      ...
      title: "Jobs",
      description:
        "Different jobs: Doctor, Teacher, Police Officer, Engineer, Farmer, Chef",
    ...
    },
    {
      ...
      title: "Places",
      description:
        "Places in a city: Supermarket, Hospital, School, Park, Library, Museum",
    ...
    },
    {
      ...
      title: "Big Numbers",
      description:
        "Count higher: Ten, Twenty, Fifty, Hundred, Thousand, Million",
  ...
  ortaokul: [
    {
      ...
      title: "Past Tense",
      description:
        "Talk about the past: I played, She went, They saw, We ate, He ran",
    ...
    },
    {
      ...
      description:
        "Actions happening now: I am playing, She is reading, They are eating",
    ...
    },
    {
      ...
      title: "Future Tense",
      description:
        "Talk about future with 'will': I will go, They will see, She will come",
    ...
    },
    {
      ...
      title: "Conditionals",
      description:
        "If/then sentences: If I study, I will pass. If it rains, we stay inside.",
    ...
    },
    {
      ...
      title: "Environment",
      description:
        "Our planet: Pollution, Recycling, Climate Change, Nature, Ecosystem",
    ...
    },
    {
      ...
      title: "Technology",
      description:
        "Tech words: Computer, Internet, Application, Smartphone, Software, Robot",
    ...
    },
    {
      ...
      title: "Health",
      description:
        "Staying healthy: Sick, Doctor, Medicine, Surgery, Exercise, Nutrition",
    ...
    },
    {
      ...
      title: "Comparisons",
      description:
        "Compare things: Bigger/Biggest, Faster/Fastest, More interesting/Most interesting",
    ...
    },
    {
      ...
      title: "Daily Phrases",
      description:
        "Polite phrases: I'm sorry, Please, You're welcome, Excuse me, Could you help me?",
    ...
    },
    {
      ...
      title: "Modal Verbs",
      description:
        "Modals for ability/obligation: Can, Must, Should, Would, Could, Might, May",
    ...
    },
    {
      ...
      description:
        "Ask questions with: Who, What, Where, When, Why, How, Which, Whose",
    ...
    },
    {
      ...
      description:
        "Real dialogues: Introducing yourself, Shopping, Asking directions, Making plans",
    ...
    },
    {
      ...
      title: "Passive Voice",
      description:
        "Passive form: is made, was written, will be done, has been built",
    ...
    },
    {
      ...
      title: "Linking Words",
      description:
        "Connect ideas: And, But, Because, However, Therefore, Although, Moreover",
      example:
...
const englishDataEs: Record<Level, EngItem[]> = {
  okul_oncesi: [
    {
      key: "eng_colors",
      emoji: "🌈",
      ...
      description:
        "Aprende tus primeros colores en inglés: Red (rojo), Blue (azul), Yellow (amarillo), Green (verde)",
    ...
    },
    {
      ...
      description:
        "Cuenta del uno al diez en inglés: One, Two, Three, Four, Five, Six, Seven, Eight, Nine, Ten",
    ...
    },
    {
      ...
      description:
        "Animales en inglés: Dog (perro), Cat (gato), Bird (pájaro), Fish (pez), Rabbit (conejo)",
    ...
    },
    {
      ...
      description:
        "Palabras de familia en inglés: Mother (mamá), Father (papá), Brother (hermano), Sister (hermana)",
    ...
    },
    {
      ...
      description:
        "Comidas en inglés: Apple (manzana), Bread (pan), Milk (leche), Egg (huevo), Rice (arroz)",
    ...
    },
    {
      ...
      description:
        "Saludar en inglés: Hello (hola), Good morning (buenos días), Goodbye (adiós), Thank you (gracias)",
      example: "Hello! How are you? I am fine, thank you!",
    },
    {
      key: "eng_shapes",
      ...
      description:
        "Figuras geométricas en inglés: Circle (círculo), Square (cuadrado), Triangle (triángulo), Star (estrella)",
    ...
    },
    {
      ...
      description:
        "Partes del cuerpo en inglés: Eye (ojo), Ear (oreja), Nose (nariz), Hand (mano), Foot (pie)",
    ...
    },
    {
      ...
      description:
        "Juguetes en inglés: Ball (pelota), Doll (muñeca), Car (coche), Kite (cometa), Teddy bear (osito)",
      example: "I play with my ball every day!",
    },
    {
      key: "eng_fruits",
      ...
      description:
        "Frutas en inglés: Apple (manzana), Banana (plátano), Strawberry (fresa), Grape (uva), Orange (naranja)",
    ...
    },
    {
      ...
      description:
        "La naturaleza en inglés: Flower (flor), Tree (árbol), Sun (sol), Star (estrella), Moon (luna)",
    ...
    },
    {
      ...
      description:
        "Describir tamaños en inglés: Big (grande), Small (pequeño), Tall (alto), Short (bajo), Long (largo)",
      example: "The elephant is big. The mouse is small.",
    },
    {
      key: "eng_feelings",
      ...
      description:
        "¿Cómo te sientes? Happy (feliz), Sad (triste), Angry (enojado), Scared (asustado), Excited (emocionado)",
    ...
    },
    {
      ...
      description:
        "Medios de transporte en inglés: Bus (autobús), Car (coche), Airplane (avión), Bicycle (bicicleta), Train (tren)",
      example: "I ride the bus to school every day.",
    },
  ],
  ilkokul: [
    {
      ...
      description:
        "En la escuela encontrarás: Teacher (maestro), Book (libro), Pencil (lápiz), Desk (escritorio), Classroom (aula)",
    ...
    },
    {
      ...
      description:
        "Describir el tiempo en inglés: Sunny (soleado), Rainy (lluvioso), Snowy (nevado), Cloudy (nublado), Windy (ventoso)",
      example: "Today is sunny. Yesterday it was rainy.",
    },
    {
      key: "eng_days",
      ...
      description:
        "Los siete días en inglés: Monday (lunes), Tuesday (martes), Wednesday (miércoles), Thursday (jueves), Friday (viernes)",
      example: "Today is Monday. School starts on Monday.",
    },
    {
      key: "eng_months",
      ...
      description:
        "Los doce meses en inglés: January (enero), February (febrero), March (marzo), April (abril), May (mayo), June (junio)",
    ...
    },
    {
      ...
      description:
        "Actividades divertidas en inglés: Reading (leer), Playing (jugar), Swimming (nadar), Drawing (dibujar), Singing (cantar)",
      example: "I like swimming in summer. I love drawing too!",
    },
    {
      key: "eng_home",
      ...
      description:
        "Habitaciones de la casa en inglés: Kitchen (cocina), Living room (sala), Bathroom (baño), Bedroom (dormitorio)",
      example: "I sleep in my bedroom. We cook in the kitchen.",
    },
    {
      key: "eng_clothes",
      ...
      description:
        "Prendas de vestir en inglés: Shirt (camisa), Pants (pantalón), Shoes (zapatos), Hat (sombrero), Jacket (chaqueta)",
      example: "I wear a hat in the sun. I wear a jacket in winter.",
    },
    {
      key: "eng_verbs",
      ...
      description:
        "Verbos de acción en inglés: Run (correr), Sit (sentarse), Eat (comer), Sleep (dormir), Walk (caminar), Jump (saltar)",
      example: "I run every day. She reads before bed.",
    },
    {
      key: "eng_adjectives",
      ...
      description:
        "Palabras descriptivas en inglés: Big (grande), Small (pequeño), Fast (rápido), Old (viejo), New (nuevo), Beautiful (hermoso)",
      example: "The elephant is big. My dog is funny!",
    },
    {
      key: "eng_sports",
      ...
      description:
        "Deportes populares en inglés: Football (fútbol), Swimming (natación), Running (carrera), Tennis (tenis), Basketball (baloncesto)",
      example: "I play football on Saturdays. I love basketball too!",
    },
    {
      key: "eng_prepositions",
      ...
      description:
        "Palabras de posición en inglés: On (sobre), Under (debajo), In (dentro), Next to (al lado de), Behind (detrás)",
      example: "The book is on the table. The cat is under the chair.",
    },
    {
      key: "eng_time",
      ...
      description:
        "Partes del día en inglés: Morning (mañana), Noon (mediodía), Afternoon (tarde), Evening (noche), Night (noche)",
      example: "I wake up in the morning. I go to bed at night.",
    },
    {
      key: "eng_jobs",
      ...
      description:
        "Profesiones en inglés: Doctor (médico), Teacher (maestro), Police Officer (policía), Engineer (ingeniero), Farmer (agricultor)",
      example: "My father is a doctor. My mother is a teacher.",
    },
    {
      key: "eng_places",
      ...
      description:
        "Lugares en la ciudad en inglés: Supermarket (supermercado), Hospital (hospital), School (escuela), Park (parque), Library (biblioteca)",
      example: "We go to the park on Sundays. The library has many books.",
    },
    {
      key: "eng_numbers2",
      ...
      description:
        "Cuenta más alto en inglés: Ten (diez), Twenty (veinte), Fifty (cincuenta), Hundred (cien), Thousand (mil), Million (millón)",
      example: "There are twenty students in my class.",
    },
  ],
  ortaokul: [
    {
      ...
      description:
        "Habla del pasado en inglés: I played (jugué), She went (ella fue), They saw (ellos vieron), We ate (comimos)",
      example: "I went to school yesterday. She played tennis last week.",
    },
    {
      key: "eng_present",
      ...
      description:
        "Acciones que ocurren ahora en inglés: I am playing (estoy jugando), She is reading (ella está leyendo)",
      example: "She is reading a book right now. We are studying.",
    },
    {
      key: "eng_future",
      ...
      description:
        "Habla del futuro con 'will' en inglés: I will go (iré), They will see (verán), She will come (vendrá)",
      example: "I will travel next year. They will visit us tomorrow.",
    },
    {
      key: "eng_conditionals",
      ...
      description:
        "Oraciones con 'si' en inglés: If I study, I will pass. If it rains, we stay inside.",
      example: "If it rains, I will stay home. If you try, you will succeed!",
    },
    {
      key: "eng_environment",
      ...
      description:
        "Vocabulario ambiental en inglés: Pollution (contaminación), Recycling (reciclaje), Climate Change (cambio climático)",
      example: "We must protect nature. Recycle to save the Earth!",
    },
    {
      key: "eng_technology",
      ...
      description:
        "Términos tecnológicos en inglés: Computer (computadora), Internet, Application (aplicación), Smartphone, Software, Robot",
      example: "I use the internet for homework. Technology helps us learn.",
    },
    {
      key: "eng_health",
      ...
      description:
        "Vocabulario de salud en inglés: Sick (enfermo), Doctor (médico), Medicine (medicina), Surgery (cirugía), Exercise (ejercicio)",
      example: "I see a doctor when I am sick. Exercise keeps you healthy.",
    },
    {
      key: "eng_compare",
      ...
      description:
        "Comparar en inglés: Bigger/Biggest (más grande/el más grande), Faster/Fastest (más rápido), More interesting/Most interesting",
      example: "She is taller than me. This is the most interesting book.",
    },
    {
      key: "eng_phrases",
      ...
      description:
        "Frases de cortesía en inglés: I'm sorry (lo siento), Please (por favor), You're welcome (de nada), Excuse me (con permiso)",
      example: "Excuse me, where is the library? I'm sorry for being late.",
    },
    {
      key: "eng_modal",
      ...
      description:
        "Modales en inglés: Can (poder), Must (deber), Should (debería), Would (condicional), Could (podría), May (puede que)",
      example: "You should study every day. You can do it!",
    },
    {
      key: "eng_question",
      ...
      description:
        "Hacer preguntas en inglés: Who (quién), What (qué), Where (dónde), When (cuándo), Why (por qué), How (cómo)",
      example: "Where do you live? Why are you late? How was your day?",
    },
    {
      key: "eng_conversation",
      ...
      description:
        "Diálogos reales en inglés: Presentarse, Ir de compras, Pedir direcciones, Hacer planes",
      example: "A: How are you? B: I'm fine, thank you. Nice to meet you!",
    },
    {
      key: "eng_passive",
      ...
      description:
        "La forma pasiva en inglés: is made (es hecho), was written (fue escrito), will be done (será hecho)",
      example: "This book was written in 1900. The bridge was built last year.",
    },
    {
      key: "eng_linking",
      ...
      description:
        "Conectar ideas en inglés: And (y), But (pero), Because (porque), However (sin embargo), Therefore (por lo tanto)",
      example:
        "I studied hard, therefore I passed. I was tired, but I finished.",
    },
  ],
...
const levelTabsEs: { key: Level; label: string }[] = [
...
export default function EnglishPage() {
  ...
  const filtered = englishData[level].filter(
    (p) =>
      ...
      p.example.toLowerCase().includes(searchTerm.toLowerCase()),
  );

...
export default function MathPracticePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-indigo-500">
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        {/* Level Tabs */}
        <div className="flex gap-2 mb-6" data-ocid="mathpractice.level.tab">
          ...
          <>
            ...
            <div className="mb-4">
              <div className="flex justify-between text-white/80 text-sm mb-1">
                <span>
                  {currentIndex + 1}/{total} soru tamamlandı
                </span>
            ...
            >
              <div className="text-center mb-6">
                <div className="text-5xl mb-3">{currentProblem.emoji}</div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {currentProblem.options.map((option, idx) => {
                  let btnClass =
                    "py-4 px-4 rounded-xl text-lg font-bold border-2 transition-all ";
              ...
              {selectedAnswer !== null && (
                <div
                  ...
                  data-ocid={
                    isCorrect
                      ? "mathpractice.correct_state"
                      : "mathpractice.wrong_state"
                  }
                >
                  {isCorrect
                    ? "✅ Doğru! +15 puan"

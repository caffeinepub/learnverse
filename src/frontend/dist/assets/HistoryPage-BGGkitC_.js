import { u as useNavigate, a as useLanguage, d as getCurrentUser, r as reactExports, t as trackContentVisit, e as getReadTopics, j as jsxRuntimeExports, f as updatePoints, i as incrementDailyContentRead, m as markTopicRead } from "./index-fWEGaXw3.js";
import { F as FlashcardMode } from "./FlashcardMode-D9p4r09R.js";
import "./proxy-W83bttYQ.js";
const historyDataTr = {
  okul_oncesi: [
    {
      key: "hist_ataturk1",
...
function HistoryPage() {
  ...
  const historyData = isEn ? historyDataEn : isEs ? historyDataEs : isFr ? historyDataFr : historyDataTr;
  const levelTabs = isEn ? levelTabsEn : isEs ? levelTabsEs : isFr ? levelTabsFr : levelTabsTr;
  ...
  const handleSpeak = (id, text) => {
    if (speakingId === id) {
      ...
      utt.lang = isEn ? "en-US" : isEs ? "es-ES" : isFr ? "fr-FR" : "tr-TR";

...
const regions = [
  {
    ...
    featuresZh: "土耳其人口最多的地区。伊斯坦布尔是最大城市。工业和商业中心。被马尔马拉海环绕。",
  ...
  },
  {
    ...
    featuresZh: "以橄榄树和葡萄园闻名。伊兹密尔是土耳其第三大城市。以弗所和帕加马古城位于此处。",
  ...
  },
  {
    ...
    featuresZh: "旅游业非常重要。地中海气候。托罗斯山脉在此。柑橘类水果产量领先。",
  ...
  },
  {
    ...
    featuresZh: "土耳其首都安卡拉在此。草原气候和广阔平原。卡帕多西亚的仙女烟囱在此。小麦产量领先。",
  ...
  },
  {
    ...
    featuresZh: "多雨气候和郁郁葱葱的自然环境。茶叶和榛子产量世界领先。位于黑海沿岸。",
  ...
  },
  {
    ...
    featuresZh: "海拔最高、气候最寒冷的地区。亚拉拉特山是土耳其最高点（5165米）。凡湖是土耳其最大的湖泊。",
  ...
  },
  {
    ...
    featuresZh: "被称为黑海的门户。凯末尔于1919年5月19日在此城市开始独立战争。烟草和榛子生产重要。",
    nameHi: "दक्षिण-पूर्वी अनातोलिया",
  ...
  },
  {
    ...
    featuresZh: "遍布世界著名的茶园和榛子园。特拉布宗城堡和圣索菲亚博物馆是重要历史遗址。黑海美食中心。",
    nameHi: "सामसुन",
    provincesHi: ["सामसुन", "इल्कादिम", "कानिक", "अताकुम", "बाफरा"],
    featuresHi: "काला सागर का प्रवेश द्वार। अतातुर्क ने 1919 में यहाँ से स्वतंत्रता संग्राम शुरू किया।"
  },
  {
    key: "map_erzurum",
    name: "Erzurum",
    ...
    featuresZh: "土耳其最寒冷、海拔最高的城市之一。帕兰多肯滑雪中心使冬季旅游业发展重要。凯末尔在此主持埃尔祖鲁姆大会的历史城市。",
    nameHi: "त्राबज़ोन",
  ...
  },
  {
    ...
    featuresZh: "土耳其的美食之都。果仁蜜饼和开心果甜点举世闻名。土耳其第六大城市。",
    nameHi: "गाज़ियांटेप",
  ...
  },
  {
    ...
    featuresZh: "以联合国教科文组织世界遗产名录中的黑色玄武岩城墙闻名。建于底格里斯河岸边。以西瓜著名。有5000年历史。",
    nameHi: "दियारबाकिर",
    provincesHi: ["दियारबाकिर", "बागलार", "कायापिनार", "सुर", "एर्गानी"],
    featuresHi: "प्राचीन बेसाल्ट दीवारों के लिए UNESCO विश्व धरोहर। तरबूज़ उत्पादन का केंद्र।"
  }
];
...
function TurkeyMapPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-red-500 to-red-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl font-black text-white mb-4", children: [
      "🗺️",
      " ",
      isZh ? "土耳其地图" : isEs ? "Mapa de Turquía" : isFr ? "Carte de Turquie" : isEn ? "Turkey Map" : "Türkiye Haritası"
    ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            "📖",
            " ",
            isZh ? "学习" : isEs ? "Aprender" : isFr ? "Apprendre" : isEn ? "Learn" : "Öğren"
          ]
        }
      ),
    ...
    mode === "learn" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/20 rounded-2xl p-3 mb-4 flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-white text-xs mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold", children: isZh ? "已学习地区" : isEs ? "Regiones aprendidas" : isEn ? "Regions learned" : "Öğrenilen bölgeler" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-black", children: isZh ? r.nameZh : isHi ? r.nameHi : isEs ? r.nameEs : isFr ? r.nameFr : isEn ? r.nameEn : r.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white/80 text-xs", children: [
                  (isZh ? r.provincesZh : isHi ? r.provincesHi : isEs ? r.provincesEs : isFr ? r.provincesFr : isEn ? r.provincesEn : r.provinces).slice(0, 3).join(", "),
                  "..."
                ] })
              ] }),
        ...
        selected === r.key && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/20 px-4 py-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white font-bold text-xs mb-1", children: [
              "🏙️",
              " ",
              isZh ? "重要省份:" : isEs ? "Provincias Clave:" : isEn ? "Key Provinces:" : "Önemli İller:"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: (isZh ? r.provincesZh : isEs ? r.provincesEs : isEn ? r.provincesEn : r.provinces).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white font-bold text-xs mb-1", children: [
              "ℹ️",
              " ",
              isZh ? "特点:" : isEs ? "Características:" : isEn ? "Features:" : "Özellikler:"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/80 text-xs", children: isZh ? r.featuresZh : isEs ? r.featuresEs : isEn ? r.featuresEn : r.features })
          ] }),
    ...
    mode === "quiz" && quizRegion && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/20 rounded-2xl p-4 mb-4 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white/70 text-xs mb-1", children: [
          isZh ? "分数" : isEs ? "Puntos" : isFr ? "Points" : isEn ? "Score" : "Puan",
          ": ",
          score,
          " |",
          " ",
          isZh ? "题目" : isEs ? "Pregunta" : isFr ? "Question" : isEn ? "Question" : "Soru",
          ": ",
          quizCount
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-black text-lg mb-2", children: isZh ? "这是哪个地区？" : isEs ? "¿Qué región es esta?" : isEn ? "Which region is this?" : "Bu bölge hangisidir?" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white/80 text-sm", children: [
          isZh ? "省份" : isEs ? "Provincias" : isFr ? "Provinces" : isEn ? "Provinces" : "İller",
          ":",
          " ",
          (isZh ? quizRegion.provincesZh : isEs ? quizRegion.provincesEs : isEn ? quizRegion.provincesEn : quizRegion.provinces).slice(0, 2).join(", "),
          "..."
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: quizChoices.map((choice, cIdx) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: isZh ? choice.nameZh : isHi ? choice.nameHi : isEs ? choice.nameEs : isFr ? choice.nameFr : isEn ? choice.nameEn : choice.name
          },
          choice.key
        );
      }) }),

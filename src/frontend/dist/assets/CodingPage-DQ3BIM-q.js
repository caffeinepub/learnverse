  ...
  okul_oncesi: [
    {
      ...
      emoji: "👣",
      title: "कदम",
      info: "काम करने के लिए एक-एक कदम उठाने होते हैं। पहले डिब्बा खोलो, फिर खाना गर्म करो, फिर खाओ।",
      example: "दाँत साफ करना: 1) ब्रश उठाओ, 2) पेस्ट लगाओ, 3) ब्रश करो, 4) कुल्ला करो"
    },
    {
      key: "cod_kram_hi",
      emoji: "🔢",
      title: "क्रम",
      info: "कंप्यूटर क्रम से निर्देश मानता है। अगर कदमों का क्रम गलत हो तो काम बिगड़ जाता है।",
      example: "गलत: पहले कपड़े पहनो फिर उठो। सही: पहले उठो फिर कपड़े पहनो।"
    },
    {
      key: "cod_dohrana_hi",
      emoji: "🔁",
      title: "दोहराना",
      info: "कभी-कभी हमें एक ही काम कई बार करना पड़ता है। कंप्यूटर इसे अपने आप दोहरा सकता है।",
      example: "10 कदम चलो: चलो, चलो, चलो... (10 बार)"
    },
    {
      key: "cod_chunav_hi",
      emoji: "🤔",
      title: "चुनाव",
      info: "'अगर बारिश हो तो छाता लो, नहीं तो मत लो।' यह एक चुनाव है।",
      example: "अगर भूख लगी → खाना खाओ। नहीं तो → खेलने जाओ।"
    },
    {
      key: "cod_robot_hi",
      emoji: "🤖",
      title: "रोबोट खेल",
      info: "तुम रोबोट को एक निर्देश देते हो और वह ठीक वैसा ही करता है जैसे '3 कदम आगे जाओ, दाएँ मुड़ो'।",
      example: "निर्देश: आगे, पीछे, दाएँ मुड़ो, बाएँ मुड़ो, रुको"
    },
    {
      key: "cod_code_hi",
      emoji: "🔐",
      title: "कूट भाषा",
      info: "संदेश को कोड में लिखना मज़ेदार है! हम अक्षरों की जगह संख्याएँ लिख सकते हैं जैसे A=1, B=2।",
      example: "HELLO → 8-5-12-12-15"
    },
    {
      key: "cod_rasta_hi",
      emoji: "🗺️",
      title: "रास्ता बताना",
      info: "एक जगह से दूसरी जगह जाने के लिए कदम-दर-कदम रास्ता बताना एक एल्गोरिदम है।",
      example: "दाएँ मुड़ो, 3 कदम चलो, दरवाज़ा खोलो।"
    },
    {
      key: "cod_pattern_hi",
      emoji: "🎨",
      title: "पैटर्न",
      info: "पैटर्न एक दोहराने वाला नियम है, जैसे लाल, नीला, लाल, नीला... अगला क्या होगा?",
      example: "🔴🔵🔴🔵 → अगला है 🔴"
    }
  ],
  ilkokul: [
    {
      ...
      emoji: "📋",
      title: "एल्गोरिदम",
      info: "एल्गोरिदम एक समस्या हल करने के लिए कदम-दर-कदम तरीका है। जैसे खाना बनाने की विधि।",
      example: "सबसे बड़ी संख्या ढूँढने का एल्गोरिदम: दो संख्याओं की तुलना करो, बड़ी को रखो।"
    },
    {
      key: "cod_loop_hi",
      emoji: "🔄",
      title: "लूप",
      info: "लूप कोड के एक हिस्से को बार-बार चलाता है। जैसे '10 बार दोहराओ: एक कदम आगे'।",
      example: "for i in range(5): print('नमस्ते') → 5 बार 'नमस्ते' छपेगा"
    },
    {
      key: "cod_if_hi",
      emoji: "🚦",
      title: "if कथन",
      info: "if कथन कंप्यूटर को शर्त के आधार पर निर्णय लेने देता है: अगर... तो... नहीं तो...",
      example: "अगर अंक >= 60: पास। नहीं तो: फेल।"
    },
    {
      key: "cod_variable_hi",
      emoji: "📦",
      title: "चर (Variable)",
      info: "चर एक डिब्बे की तरह है जिसमें संख्या, शब्द या अन्य जानकारी रखी जा सकती है।",
      example: "अंक = 100, नाम = 'राम', इसे कभी भी बदला जा सकता है।"
    },
    {
      key: "cod_function_hi",
      emoji: "⚙️",
      title: "फ़ंक्शन",
      info: "फ़ंक्शन कोड का एक हिस्सा है जिसे बार-बार इस्तेमाल किया जा सकता है।",
      example: "def नमस्कार(): print('नमस्ते!') → जब चाहो बुलाओ"
    },
    {
      key: "cod_list_hi",
      emoji: "📝",
      title: "सूची (List)",
      info: "सूची एक जगह कई चीज़ें रखने का तरीका है। जैसे खरीदारी की सूची।",
      example: "फल = ['सेब', 'केला', 'संतरा']"
    },
    {
      key: "cod_debug_hi",
      emoji: "🐛",
      title: "डीबगिंग",
      info: "डीबगिंग प्रोग्राम में गलतियाँ ढूँढना और ठीक करना है। यह एक महत्वपूर्ण कौशल है।",
      example: "गलती: 2+2=5 → ढूँढो और ठीक करो → 2+2=4"
    },
    {
      key: "cod_scratch_hi",
      emoji: "🎮",
      title: "ब्लॉक कोडिंग",
      info: "स्क्रैच जैसे टूल में ब्लॉक को जोड़कर प्रोग्राम बनाया जाता है। यह बच्चों के लिए आसान है।",
      example: "जब हरा झंडा दबाओ → बिल्ली 10 कदम आगे जाए"
    }
  ],
  ortaokul: [
    {
      ...
      emoji: "🐍",
      title: "Python",
      info: "Python एक लोकप्रिय प्रोग्रामिंग भाषा है जो पढ़ने में आसान है और बहुत काम में आती है।",
      example: "print('नमस्ते दुनिया!') → स्क्रीन पर 'नमस्ते दुनिया!' दिखेगा"
    },
    {
      key: "cod_recursion_hi",
      emoji: "🌀",
      title: "पुनरावृत्ति",
      info: "पुनरावृत्ति वह प्रक्रिया है जिसमें एक फ़ंक्शन खुद को बुलाता है। यह जटिल समस्याएँ हल करता है।",
    ...
    },
    {
      ...
      emoji: "📊",
      title: "Array",
      info: "Array एक ही प्रकार के डेटा का संग्रह है। इससे कई मानों को एक साथ संभाला जा सकता है।",
      example: "अंक = [85, 90, 78, 92, 88]; औसत = sum(अंक)/len(अंक)"
    },
    {
      key: "cod_oop_hi",
      emoji: "🏗️",
      title: "OOP",
      info: "ऑब्जेक्ट-ओरिएंटेड प्रोग्रामिंग में वस्तुओं और वर्गों का उपयोग करके प्रोग्राम लिखा जाता है।",
      example: "class कार: रंग, इंजन, चलना() — हर कार एक ऑब्जेक्ट है"
    },
    {
      key: "cod_web_hi",
      emoji: "🌐",
      title: "वेब विकास",
      info: "HTML, CSS और JavaScript का उपयोग करके वेबसाइट बनाई जाती है।",
      example: "<h1>नमस्ते!</h1> → वेबपेज पर बड़ा शीर्षक दिखेगा"
    },
    {
      key: "cod_ai_hi",
      emoji: "🤖",
      title: "आर्टिफिशियल इंटेलिजेंस",
      info: "AI कंप्यूटर को मनुष्यों की तरह सोचने और सीखने की क्षमता देता है।",
      example: "स्पैम फ़िल्टर, अनुवाद ऐप, चेहरा पहचान — ये सब AI हैं"
    },
    {
      key: "cod_data_hi",
      emoji: "🗄️",
      title: "डेटा संरचना",
      info: "डेटा संरचना डेटा को व्यवस्थित तरीके से संग्रहीत करने की पद्धति है।",
      example: "Stack: ऊपर से डालो और ऊपर से निकालो (LIFO)"
    },
    {
      key: "cod_cybersec_hi",
      emoji: "🔒",
      title: "साइबर सुरक्षा",
      info: "साइबर सुरक्षा कंप्यूटर और इंटरनेट को हमलों से बचाने की विद्या है।",
      example: "मजबूत पासवर्ड, दो-चरण सत्यापन, और अपरिचित लिंक न खोलना"
    }
  ]
};
const levelTabsHi = [
...
function CodingPage() {
  ...
  const codingData = isZh ? codingDataZh : isFr ? codingDataFr : isHi ? codingDataHi : isEn ? codingDataEn : isEs ? codingDataEs : codingDataTr;
  const levelTabs = isZh ? levelTabsZh : isFr ? levelTabsFr : isHi ? levelTabsHi : isEn ? levelTabsEn : isEs ? levelTabsEs : levelTabsTr;

import { u as useNavigate, a as useLanguage, d as getCurrentUser, r as reactExports, t as trackContentVisit, e as getReadTopics, j as jsxRuntimeExports, f as updatePoints, i as incrementDailyContentRead, m as markTopicRead } from "./index-B0Kplu0k.js";
import { F as FlashcardMode } from "./FlashcardMode-wB1K-4EN.js";
import "./proxy-C0OQvu0S.js";
const historyDataTr = {
  okul_oncesi: [
    {
      key: "hist_ataturk1",
...
function HistoryPage() {
  ...
  const historyData = isEn ? historyDataEn : isEs ? historyDataEs : historyDataTr;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-amber-800 to-yellow-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl font-black text-white", children: [
        "🏛️",
        " ",
        isEn ? "History Cards" : isEs ? "Tarjetas de Historia" : "Tarih Kartları"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {

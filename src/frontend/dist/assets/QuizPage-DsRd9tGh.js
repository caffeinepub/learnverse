import { u as useNavigate, d as getCurrentUser, a as useLanguage, r as reactExports, E as getLastQuizScore, Z as hasPlayedQuizToday, _ as getDueSpacedItems, j as jsxRuntimeExports, B as Button, $ as markSpacedRepCorrect, a0 as markSpacedRepWrong, a1 as playAudio, a2 as saveWrongAnswer, a3 as addToSpacedRep, f as updatePoints, a4 as markQuizPlayedToday, J as updateDailyGoals, a5 as updateStreak, a6 as saveTopicStats, a7 as saveQuizResult, a8 as setLastQuizScore, a9 as syncToBackend } from "./index-CsapSQCz.js";
...
function QuizPage() {
  ...
  const [allQuestions] = reactExports.useState(() => {
    ...
    return getAdaptiveDailyQuestions((profile == null ? void 0 : profile.level) || "ilkokul", lastScore);
  });
  ...
  if (phase === "topicSelect") {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-purple-700 via-indigo-700 to-blue-700 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg mx-auto", children: [
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-black text-sm", children: lang === "en" ? `${dueCount} question${dueCount > 1 ? "s" : ""} due for review` : `${dueCount} soru tekrar için bekliyor` }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-orange-100 text-xs", children: lang === "en" ? "These will appear at the start of your next quiz" : "Bir sonraki quizinin başında görünecekler" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/10 backdrop-blur-sm rounded-3xl p-6 mb-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white font-black text-2xl text-center mb-1", children: lang === "en" ? "Choose Quiz Topic" : "Quiz Konusu Seç" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-sm text-center", children: lang === "en" ? "Select a topic or play the daily quiz" : "Bir konu seç veya günlük quiz oyna" })
      ] }),
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              isAllTopic && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/80 text-xs mt-1", children: disabled ? lang === "en" ? "✅ Already played today" : "✅ Bugün oynadın" : lang === "en" ? "Daily quiz • 1 per day • earns streak" : "Günlük quiz • Günde 1 kez • Seri kazanır" }),
              !isAllTopic && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white/80 text-xs mt-1", children: lang === "en" ? "Topic quiz • Unlimited" : "Konu quizi • Sınırsız" })
            ]
          },
          tc.id
        );
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: lang === "en" ? "Play Again" : "Tekrar Oyna"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,

        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-black", children: isZh ? r.nameZh : isEs ? r.nameEs : isFr ? r.nameFr : isEn ? r.nameEn : r.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white/80 text-xs", children: [
                  (isZh ? r.provincesZh : isEs ? r.provincesEs : isFr ? r.provincesFr : isEn ? r.provincesEn : r.provinces).slice(0, 3).join(", "),
                  "..."
                ] })
              ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: quizChoices.map((choice, cIdx) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: isZh ? choice.nameZh : isEs ? choice.nameEs : isFr ? choice.nameFr : isEn ? choice.nameEn : choice.name
          },
          choice.key
        );
      }) }),

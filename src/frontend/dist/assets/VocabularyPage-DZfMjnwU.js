import { r as reactExports, j as jsxRuntimeExports, u as useNavigate, a as useLanguage, d as getCurrentUser, t as trackContentVisit, e as getReadTopics, f as updatePoints, i as incrementDailyContentRead, m as markTopicRead } from "./index-dncktxyT.js";
import { m as motion, A as AnimatePresence, F as FlashcardMode } from "./FlashcardMode-C38jWnRE.js";
...
function VocabularyPage() {
  ...
  const filteredWords = vocabulary[level].filter((w) => {
    ...
    const displayWord = lang === "en" && (enTr == null ? void 0 : enTr.word) ? enTr.word : w.word;
    const displayDef = lang === "en" && (enTr == null ? void 0 : enTr.definition) ? enTr.definition : w.definition;
  ...
  const flashCards = vocabulary[level].map((w) => {
    ...
    return {
      key: w.key,
      front: lang === "en" && (enTr == null ? void 0 : enTr.word) ? enTr.word : w.word,
      back: lang === "en" && (enTr == null ? void 0 : enTr.definition) ? enTr.definition : w.definition,
      emoji: w.emoji
    };
  });
  const spellingWords = vocabulary[level].map((w) => {
    ...
    return {
      key: w.key,
      word: lang === "en" && (enTr == null ? void 0 : enTr.word) ? enTr.word : w.word,
      emoji: w.emoji
    };
  });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-purple-600 to-violet-500", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: filteredWords.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      const displayWord = lang === "en" && (enTr == null ? void 0 : enTr.word) ? enTr.word : w.word;
      const displayDef = lang === "en" && (enTr == null ? void 0 : enTr.definition) ? enTr.definition : w.definition;
      const displaySynonym = lang === "en" && (enTr == null ? void 0 : enTr.synonym) ? enTr.synonym : w.synonym;
      const displayAntonym = lang === "en" && (enTr == null ? void 0 : enTr.antonym) ? enTr.antonym : w.antonym;
      const displayExample = lang === "en" && (enTr == null ? void 0 : enTr.example) ? enTr.example : w.example;

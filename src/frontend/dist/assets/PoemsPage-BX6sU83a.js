import { u as useNavigate, a as useLanguage, d as getCurrentUser, r as reactExports, t as trackContentVisit, e as getReadTopics, x as isFavorite, j as jsxRuntimeExports, B as Button, f as updatePoints, y as toggleFavorite, m as markTopicRead, i as incrementDailyContentRead } from "./index-fWEGaXw3.js";
import { W as WordDefinitionTooltip } from "./WordDefinitionTooltip-BPHJlRrR.js";
const poemsEn = {
  okul_oncesi: [
    {
      key: "poem_yagmur",
...
function PoemsPage() {
  ...
  const activePoems = lang === "en" ? poemsEn : lang === "es" ? poemsEs : lang === "fr" ? poemsFr : poems;

import { u as useNavigate, a as useLanguage, d as getCurrentUser, r as reactExports, t as trackContentVisit, e as getReadTopics, j as jsxRuntimeExports, B as Button, m as markTopicRead, f as updatePoints, i as incrementDailyContentRead } from "./index-KcrWLd1W.js";
const musicNotesTr = [
  {
    key: "music_do",
    note: "Do",
...
const musicNotesFr = [
  {
    ...
    emoji: "🎵",
    freq: "C - 261 Hz",
    desc: "La premiere note de la gamme. Un son fort et fondamental. Commence par une touche blanche sur le piano.",
    color: "from-red-400 to-red-600"
  },
  {
    key: "music_re",
    ...
    emoji: "🎶",
    freq: "D - 294 Hz",
    desc: "La deuxieme note. Un son plus brillant et ouvert. Utilisee comme note fondamentale dans de nombreuses traditions.",
    color: "from-orange-400 to-orange-600"
  },
  {
    key: "music_mi",
    ...
    emoji: "🎼",
    freq: "E - 330 Hz",
    desc: "La troisieme note. Un son joyeux et lumineux. Frequemment utilisee pour l'accordage de la guitare.",
    color: "from-yellow-400 to-yellow-600"
  },
  {
    key: "music_fa",
    ...
    emoji: "🎹",
    freq: "F - 349 Hz",
    desc: "La quatrieme note. Un timbre relativement doux et plein.",
    color: "from-green-400 to-green-600"
  },
  {
    key: "music_sol",
    ...
    emoji: "🎸",
    freq: "G - 392 Hz",
    desc: "La cinquieme note. L'une des plus importantes. Dans une gamme majeure, l'harmonie la plus forte est entre Do et Sol.",
    color: "from-teal-400 to-teal-600"
  },
  {
    key: "music_la",
    ...
    emoji: "🎺",
    freq: "A - 440 Hz",
    desc: "La sixieme note. La hauteur d'accord standard internationale. Les orchestres accordent leurs instruments sur ce 'La'.",
    color: "from-blue-400 to-blue-600"
  },
  {
    key: "music_si",
    ...
    emoji: "🥁",
    freq: "B - 494 Hz",
    desc: "La septieme et derniere note. Un son haut et dynamique. La transition d'un demi-ton entre Do et Si est fascinante.",
    color: "from-violet-400 to-violet-600"
  }
];
const artistsFr = [
  {
    ...
    emoji: "🎭",
    period: "XVe-XVIe siecle",
    style: "Renaissance",
    work: "La Joconde, La Cene",
    desc: "Genie de la Renaissance italienne. Peintre, sculpteur, ingenieur et scientifique. La Joconde est le tableau le plus celebre du monde.",
    color: "from-slate-500 to-slate-700"
  },
  {
    key: "art_monet",
    ...
    work: "Les Nympheas, La Cathedrale de Rouen",
    desc: "Peintre francais. Pionnier de l'impressionnisme. Il peignait en plein air pour saisir les changements de lumiere dans la nature.",
    color: "from-purple-400 to-pink-500"
  },
  {
    key: "art_van_gogh",
    ...
    work: "La Nuit etoilee, Les Tournesols",
    desc: "Peintre neerlandais. Il representait les gens ordinaires et la nature avec de puissantes touches et des couleurs vives.",
    color: "from-yellow-500 to-orange-600"
  },
  {
    key: "art_picasso",
    ...
    style: "Cubisme",
    work: "Guernica, Les Demoiselles d'Avignon",
    desc: "Peintre espagnol. Fondateur du mouvement cubiste. Il a revolutionne l'art en montrant les objets sous plusieurs angles.",
    color: "from-blue-500 to-indigo-600"
  },
  {
    key: "art_beethoven",
    name: "Ludwig van Beethoven",
    emoji: "🎵",
    period: "XVIIIe-XIXe siecle",
    style: "Classicisme / Romantisme",
    work: "9e Symphonie, Sonate au Clair de Lune",
    desc: "Compositeur allemand. Malgre la perte de son ouie, il a cree ses plus belles oeuvres. L'Ode a la Joie est connue dans le monde entier.",
    color: "from-gray-600 to-slate-700"
  },
  {
    key: "art_mimar_sinan",
    ...
    emoji: "🕌",
    period: "XVIe siecle",
    style: "Architecture ottomane",
    work: "Mosquee Suleymanie, Mosquee Selimiye",
    desc: "Le plus grand architecte de l'Empire ottoman. Il a concu plus de 400 edifices. La Selimiye est au patrimoine mondial de l'UNESCO.",
    color: "from-teal-500 to-green-600"
  }
];
const musicNotesZh = [
  {
    ...
    emoji: "🎵",
    freq: "C - 261 Hz",
    desc: "音阶的第一个音符。一个有力的基础音。钢琴上以白键开始。",
    color: "from-red-400 to-red-600"
  },
  {
    key: "music_re",
    ...
    emoji: "🎶",
    freq: "D - 294 Hz",
    desc: "第二个音符。更明亮开放的声音。许多民间音乐传统中的根音。",
    color: "from-orange-400 to-orange-600"
  },
  {
    key: "music_mi",
  ...
  },
  {
    ...
    emoji: "🎸",
    freq: "G - 392 Hz",
    desc: "第五个音符。最重要的音符之一。在大调音阶中，Do和Sol之间的和声最强。",
    color: "from-teal-400 to-teal-600"
  },
  {
    key: "music_la",
    ...
    emoji: "🎺",
    freq: "A - 440 Hz",
    desc: "第六个音符。国际标准调音音高。管弦乐团把乐器调至'La'音。",
    color: "from-blue-400 to-blue-600"
  },
  {
    key: "music_si",
    ...
    emoji: "🥁",
    freq: "B - 494 Hz",
    desc: "第七个也是最后一个音符。高亢动感的声音。Do和Si之间的半音过渡令人着迷。",
    color: "from-violet-400 to-violet-600"
  }
];
const artistsZh = [
  {
    ...
    style: "文艺复兴",
    work: "蒙娜丽莎、最后的晚餐",
    desc: "意大利文艺复兴天才。画家、雕塑家、工程师和科学家。《蒙娜丽莎》是世界上最著名的画作。",
    color: "from-slate-500 to-slate-700"
  },
  {
    key: "art_monet",
    ...
    style: "印象主义",
    work: "睡莲、鲁昂大教堂",
    desc: "法国画家。印象主义的先驱。在户外作画以捕捉光线和颜色在自然中的变化。",
    color: "from-purple-400 to-pink-500"
  },
  {
    key: "art_van_gogh",
    ...
    style: "后印象主义",
    work: "星夜、向日葵",
    desc: "荷兰画家。用有力的笔触和鲜艳的色彩描绘普通人和自然。",
    color: "from-yellow-500 to-orange-600"
  },
  {
    key: "art_picasso",
    ...
    style: "立体主义",
    work: "格尔尼卡、亚维农少女",
    desc: "西班牙画家。立体主义运动的创始人。通过多角度展示物体彻底改变了艺术。",
    color: "from-blue-500 to-indigo-600"
  },
  {
    key: "art_beethoven",
    ...
    style: "古典主义/浪漫主义",
    work: "第九交响曲、月光奏鸣曲",
    desc: "德国作曲家。尽管失聪，仍创作了最美妙的作品。第九交响曲的《欢乐颂》举世皆知。",
    color: "from-gray-600 to-slate-700"
  },
  {
    key: "art_mimar_sinan",
    ...
    style: "奥斯曼建筑",
    work: "苏莱曼清真寺、塞利米耶清真寺",
    desc: "奥斯曼帝国最伟大的建筑师。设计了400多座建筑。塞利米耶清真寺入选联合国教科文组织世界遗产名录。",
    color: "from-teal-500 to-green-600"
  }
];
function ArtMusicPage() {
  ...
  const musicNotes = isZh ? musicNotesZh : isFr ? musicNotesFr : isEs ? musicNotesEs : isEn ? musicNotesEn : musicNotesTr;
  const artists = isZh ? artistsZh : isFr ? artistsFr : isEs ? artistsEs : isEn ? artistsEn : artistsTr;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-indigo-500 to-blue-500", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        ...
        children: [
          "←",
          " ",
          isZh ? "返回" : isEs ? "Volver" : isFr ? "Retour" : isEn ? "Back" : "Geri"
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl font-black text-white mb-4", children: [
      "🎵",
      " ",
      isZh ? "音乐 & 艺术" : isEs ? "Música & Arte" : isFr ? "Musique & Art" : isEn ? "Music & Art" : "Müzik & Sanat"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            "🎵 ",
            isEs ? "Música" : isFr ? "Musique" : isEn ? "Music" : "Müzik"
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            "🎨 ",
            isEs ? "Arte" : isFr ? "Art" : isEn ? "Art" : "Sanat"
          ]
        }
      )
    ] }),
              ...
              !isDone && profile && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    " +5",
                    " ",
                    isEs ? "pts" : isFr ? "pts" : isEn ? "pts" : "puan"
                  ]
                }
              ),

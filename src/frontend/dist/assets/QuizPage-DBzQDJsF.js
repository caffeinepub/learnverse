import { u as useNavigate, d as getCurrentUser, a as useLanguage, r as reactExports, a0 as hasPlayedQuizToday, a1 as getDueSpacedItems, j as jsxRuntimeExports, B as Button, a2 as markSpacedRepCorrect, a3 as markSpacedRepWrong, a4 as playAudio, a5 as saveWrongAnswer, a6 as addToSpacedRep, f as updatePoints, a7 as markQuizPlayedToday, O as updateDailyGoals, a8 as incrementWeeklyQuizzes, a9 as updateStreak, aa as saveTopicStats, ab as saveQuizResult, ac as setLastQuizScore, ad as syncToBackend } from "./index-B83eSkg_.js";
const extraQuestionsOkulOncesi = [
  // Fen (science) sorular
  {
...
const extraQuestionsOkulOncesi2 = [
  {
    text: "Hangi renk gökyüzünün rengidir? (fen)",
    choices: ["Kırmızı", "Mavi", "Sarı", "Yeşil"],
    correctIndex: 1,
    type: "multiple"
  },
  {
    text: "Kaç mevsim vardır? (genel)",
    choices: ["2", "3", "4", "5"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Arılar ne üretir? (fen)",
    choices: ["Süt", "Bal", "Yağ", "Tuz"],
    correctIndex: 1,
    type: "multiple"
  },
  {
    text: "Hangisi meyve değildir? (genel)",
    choices: ["Elma", "Muz", "Havuç", "Portakal"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Güneş doğudan mı yoksa batıdan mı doğar? (fen coğrafya)",
    choices: ["Batıdan", "Doğudan", "Kuzeyden", "Güneyden"],
    correctIndex: 1,
    type: "multiple"
  },
  {
    text: "Köpek balıkları nerede yaşar? (fen)",
    choices: ["Karada", "Havada", "Denizde", "Ormanda"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Hangisi uçabilen bir hayvandır? (fen)",
    choices: ["Kurbağa", "Kartal", "Tavşan", "Kaplumbağa"],
    correctIndex: 1,
    type: "multiple"
  },
  {
    text: "5 + 3 kaçtır? (matematik)",
    choices: ["6", "7", "8", "9"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Hangi hayvan çok uzun boyunlu bir hayvandır? (fen)",
    choices: ["Fil", "Zürafa", "Aslan", "Timsah"],
    correctIndex: 1,
    type: "multiple"
  },
  {
    text: "10 - 4 kaçtır? (matematik)",
    choices: ["4", "5", "6", "7"],
    correctIndex: 2,
    type: "multiple"
  }
];
const extraQuestionsIlkokul2 = [
  {
    text: "Türkiye'nin başkenti neresidir? (coğrafya)",
    choices: ["İstanbul", "Ankara", "İzmir", "Bursa"],
    correctIndex: 1,
    type: "multiple"
  },
  {
    text: "Su kaç derecede kaynar? (fen fizik)",
    choices: ["50°C", "75°C", "100°C", "120°C"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "12 x 5 kaçtır? (matematik)",
    choices: ["55", "60", "65", "70"],
    correctIndex: 1,
    type: "multiple"
  },
  {
    text: "Hangi organ kan pompalar? (fen biyoloji)",
    choices: ["Akciğer", "Beyin", "Kalp", "Karaciğer"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Osmanlı Devleti'nin kurucusu kimdir? (tarih)",
    choices: [
      "Yıldırım Bayezid",
      "Osman Bey",
      "Fatih Sultan Mehmet",
  ...
  {
    text: "Avrupa'nın en yüksek dağı hangisidir? (coğrafya)",
    choices: ["Alpler", "Mont Blanc", "Elbrus", "Etna"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Bir yılda kaç ay vardır? (matematik genel)",
    choices: ["10", "11", "12", "13"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Hangisi sürüngendir? (fen biyoloji)",
    choices: ["Kurbağa", "Yılan", "Balina", "Yarasa"],
    correctIndex: 1,
    type: "multiple"
  },
  {
    text: "Türk alfabesinde kaç harf vardır? (genel)",
    choices: ["26", "27", "28", "29"],
    correctIndex: 3,
    type: "multiple"
  },
  {
    text: "İstanbul Türkiye'nin hangi tarafında yer alır? (coğrafya)",
    choices: ["Güney", "Doğu", "Batı-kuzey", "İç Anadolu"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Fotosentez sırasında bitkiler hangi gazı üretir? (fen biyoloji)",
    choices: ["Karbondioksit", "Azot", "Oksijen", "Hidrojen"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Cumhuriyet'imiz hangi yılda ilan edildi? (tarih)",
    choices: ["1920", "1921", "1922", "1923"],
    correctIndex: 3,
    type: "multiple"
  },
  {
    text: "36 ÷ 4 kaçtır? (matematik)",
    choices: ["7", "8", "9", "10"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Dünyanın en büyük kıtası hangisidir? (coğrafya)",
    choices: ["Afrika", "Avrupa", "Amerika", "Asya"],
    correctIndex: 3,
    type: "multiple"
  },
  {
    text: "Işık hızı yaklaşık kaç km/s'dir? (fen fizik)",
    choices: ["100.000", "200.000", "300.000", "400.000"],
    correctIndex: 2,
    type: "multiple"
  }
];
const extraQuestionsOrtaokul2 = [
  {
    text: "DNA çift sarmal yapısını kim keşfetti? (fen biyoloji)",
    choices: [
      "Edison ve Tesla",
      "Watson ve Crick",
      "Darwin ve Mendel",
  ...
  {
    text: "Türkiye'nin yüz ölçümü yaklaşık kaç km²'dir? (coğrafya)",
    choices: ["581.000", "683.000", "751.000", "814.000"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Birinci Dünya Savaşı hangi yılda başladı? (tarih)",
    choices: ["1910", "1912", "1914", "1916"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Pi sayısı yaklaşık kaçtır? (matematik)",
    choices: ["2.71", "3.14", "3.41", "4.13"],
    correctIndex: 1,
    type: "multiple"
  },
  {
    text: "Asit yağmurlarının ana nedeni nedir? (fen çevre)",
    choices: [
      "CO2 emisyonu",
      "SO2 ve NOx emisyonu",
      "Ozon tabakası",
  ...
  {
    text: "Osmanlı'nın çöküşünde rol oynayan 1. Balkan Savaşı ne zaman oldu? (tarih)",
    choices: ["1908", "1910", "1912", "1914"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Bir üçgenin iç açıları toplamı kaç derecedir? (matematik)",
    choices: ["90", "120", "180", "360"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Türkiye hangi kıtalarda yer alır? (coğrafya)",
    choices: [
      "Sadece Asya",
      "Sadece Avrupa",
      "Asya ve Avrupa",
  ...
  {
    text: "Elektrik akımının birimi nedir? (fen fizik)",
    choices: ["Volt", "Watt", "Amper", "Ohm"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Atatürk hangi yılda doğdu? (tarih)",
    choices: ["1878", "1880", "1881", "1885"],
    correctIndex: 2,
    type: "multiple"
  },
  {
    text: "Işığın bükülmesine ne ad verilir? (fen fizik)",
    choices: ["Yansıma", "Kırılma", "Soğurulma", "Saçılma"],
    correctIndex: 1,
    type: "multiple"
  },
  {
  ...
  {
    text: "Hangisi yenilenebilir enerji kaynağıdır? (fen çevre)",
    choices: ["Kömür", "Petrol", "Doğal gaz", "Güneş enerjisi"],
    correctIndex: 3,
    type: "multiple"
  },
  {
    text: "Fransız Devrimi hangi yılda gerçekleşti? (tarih)",
    choices: ["1776", "1789", "1804", "1815"],
    correctIndex: 1,
    type: "multiple"
  },
  {
    text: "Mendel kalıtım kurallarını hangi bitki üzerinde çalışarak geliştirdi? (fen biyoloji)",
    choices: ["Buğday", "Domates", "Bezelye", "Mısır"],
    correctIndex: 2,
    type: "multiple"
  }
];
const questionsFrPreschool = [
  {
    type: "multiple",
...
const questionsHiPreschool = [
  {
    type: "multiple",
    text: "सूरज किस रंग का होता है?",
    choices: ["नीला", "पीला", "लाल", "हरा"],
    correctIndex: 1
  },
  {
    type: "multiple",
    text: "बिल्ली के कितने पैर होते हैं?",
    choices: ["2", "4", "6", "8"],
    correctIndex: 1
  },
  {
    type: "multiple",
    text: "कौन सा फल पीला और मुड़ा हुआ होता है?",
    choices: ["सेब", "संतरा", "केला", "अंगूर"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "मछली कहाँ रहती है?",
    choices: ["जमीन पर", "आसमान में", "पानी में", "पेड़ पर"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "किस मौसम में बर्फ पड़ती है?",
    choices: ["गर्मी", "बसंत", "शरद", "सर्दी"],
    correctIndex: 3
  },
  {
    type: "multiple",
    text: "एक हाथ में कितनी उंगलियाँ होती हैं?",
    choices: ["3", "4", "5", "6"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "इंद्रधनुष में कितने रंग होते हैं?",
    choices: ["5", "6", "7", "8"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "कौन सा जानवर दूध देता है?",
    choices: ["शेर", "गाय", "हाथी", "बाघ"],
    correctIndex: 1
  },
  {
    type: "multiple",
  ...
  {
    type: "multiple",
    text: "पौधे किससे भोजन बनाते हैं?",
    choices: ["पानी से", "मिट्टी से", "सूरज की रोशनी से", "हवा से"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "आसमान का रंग कैसा होता है?",
    choices: ["लाल", "हरा", "नीला", "पीला"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "पक्षी क्या करते हैं?",
    choices: ["तैरते हैं", "उड़ते हैं", "दौड़ते हैं", "खोदते हैं"],
    correctIndex: 1
  }
];
const questionsHiPrimary = [
  {
    type: "multiple",
  ...
  {
    type: "multiple",
    text: "पृथ्वी पर कितने महाद्वीप हैं?",
    choices: ["5", "6", "7", "8"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "सबसे बड़ा ग्रह कौन सा है?",
    choices: ["पृथ्वी", "मंगल", "बृहस्पति", "शनि"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "एक सप्ताह में कितने दिन होते हैं?",
    choices: ["5", "6", "7", "8"],
    correctIndex: 2
  },
  {
  ...
  },
  {
    ...
    choices: ["हाथी", "शेर", "बाघ", "मोर"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "सूर्य मंडल में कितने ग्रह हैं?",
    choices: ["7", "8", "9", "10"],
    correctIndex: 1
  },
  {
    type: "multiple",
    text: "दुनिया की सबसे लंबी नदी कौन सी है?",
    choices: ["गंगा", "अमेज़न", "नील", "यांग्त्ज़ी"],
    correctIndex: 2
  },
  {
    type: "multiple",
  ...
  {
    type: "multiple",
    text: "प्रकाश संश्लेषण में पौधे कौन सी गैस छोड़ते हैं?",
    choices: ["CO2", "N2", "O2", "H2"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "ताजमहल किस शहर में है?",
    choices: ["दिल्ली", "जयपुर", "आगरा", "लखनऊ"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "50 का आधा क्या होता है?",
    choices: ["20", "25", "30", "40"],
    correctIndex: 1
  }
];
const questionsHiMiddle = [
  {
    type: "multiple",
    text: "भारत को स्वतंत्रता कब मिली?",
  ...
  },
  {
    ...
    choices: ["3 लाख km/s", "1 लाख km/s", "5 लाख km/s", "10 लाख km/s"],
    correctIndex: 0
  },
  {
    type: "multiple",
    text: "मानव शरीर में कितनी हड्डियाँ होती हैं?",
    choices: ["186", "196", "206", "216"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "माउंट एवरेस्ट की ऊँचाई कितनी है?",
    choices: ["7848 मीटर", "8449 मीटर", "8849 मीटर", "9049 मीटर"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "किसने गुरुत्वाकर्षण का नियम दिया?",
    choices: ["आइंस्टीन", "न्यूटन", "डार्विन", "गैलीलियो"],
    correctIndex: 1
  },
  {
    type: "multiple",
    text: "π (पाई) का मान लगभग क्या है?",
    choices: ["2.14", "3.14", "4.14", "5.14"],
    correctIndex: 1
  },
  {
    type: "multiple",
    text: "अटलांटिक महासागर किन दो महाद्वीपों के बीच है?",
    choices: [
      "एशिया और अफ्रीका",
      "यूरोप और एशिया",
      "अमेरिका और यूरोप/अफ्रीका",
  ...
  {
    type: "multiple",
    text: "12² (बारह का वर्ग) = ?",
    choices: ["124", "134", "144", "154"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "मुगल साम्राज्य की स्थापना किसने की?",
    choices: ["अकबर", "बाबर", "हुमायूँ", "औरंगज़ेब"],
    correctIndex: 1
  },
  {
    type: "multiple",
    text: "परमाणु का केंद्र क्या कहलाता है?",
    choices: ["इलेक्ट्रॉन", "प्रोटॉन", "नाभिक", "न्यूट्रॉन"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "भारत का सबसे बड़ा राज्य (क्षेत्रफल से) कौन सा है?",
    choices: ["महाराष्ट्र", "मध्य प्रदेश", "राजस्थान", "उत्तर प्रदेश"],
    correctIndex: 2
  }
];
const questionsZhPreschool = [
  {
    type: "multiple",
    text: "太阳是什么颜色的？",
    choices: ["蓝色", "黄色", "红色", "绿色"],
...
const questionsZhPrimary = [
  ...
  },
  {
    type: "multiple",
    text: "人体有多少块骨头？",
    choices: ["106块", "206块", "306块", "406块"],
    correctIndex: 1
  },
  {
    type: "multiple",
    text: "声音在哪里传播最快？",
    choices: ["空气中", "真空中", "水中", "固体中"],
    correctIndex: 3
  },
  {
    type: "multiple",
  ...
  },
  {
    type: "multiple",
    text: "地球绕太阳一圈需要多久？",
    choices: ["30天", "90天", "265天", "365天"],
    correctIndex: 3
  }
];
const questionsZhMiddle = [
  {
    type: "multiple",
    text: "元素'Fe'代表什么？",
    choices: ["氟", "铁", "氟化物", "镄"],
  ...
  },
  {
    type: "multiple",
    text: "DNA是什么的缩写？",
    choices: ["脱氧核糖核酸", "核糖核酸", "氨基酸", "蛋白质"],
    correctIndex: 0
  },
  {
    type: "multiple",
    text: "光速大约是多少？",
    choices: ["30万千米/秒", "3万千米/秒", "300千米/秒", "3000千米/秒"],
    correctIndex: 0
  },
  {
    type: "multiple",
    text: "化学元素周期表有多少种元素？",
    choices: ["98种", "108种", "118种", "128种"],
    correctIndex: 2
  },
  {
    type: "multiple",
  ...
  },
  {
    type: "multiple",
    text: "世界最高峰是哪座山？",
    choices: ["乔戈里峰", "珠穆朗玛峰", "干城章嘉峰", "洛子峰"],
    correctIndex: 1
  },
  {
    type: "multiple",
    text: "人类大脑有多少个神经元？",
    choices: ["约1亿个", "约10亿个", "约1000亿个", "约10000亿个"],
    correctIndex: 2
  },
  {
    type: "multiple",
    text: "最古老的文明是哪个？",
    choices: ["古希腊", "古埃及", "美索不达米亚", "古印度"],
    correctIndex: 2
  },
  {
    type: "multiple",
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-black text-sm", children: lang === "es" ? `${dueCount} pregunta${dueCount > 1 ? "s" : ""} para repasar` : lang === "en" ? `${dueCount} question${dueCount > 1 ? "s" : ""} due for review` : lang === "fr" ? `${dueCount} question${dueCount > 1 ? "s" : ""} à réviser` : lang === "zh" ? `${dueCount} 道题待复习` : `${dueCount} soru tekrar için bekliyor` }),

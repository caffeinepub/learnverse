import { u as useNavigate, a as useLanguage, d as getCurrentUser, r as reactExports, t as trackContentVisit, e as getReadTopics, j as jsxRuntimeExports, m as markTopicRead, f as updatePoints, i as incrementDailyContentRead } from "./index-fWEGaXw3.js";
const scienceDataTr = {
  okul_oncesi: [
    {
      key: "sci_bitki",
...
function SciencePage() {
  ...
  const scienceData = isEs ? scienceDataEs : isEn ? scienceDataEn : scienceDataTr;
  ...
  const handleSpeak = (id, text) => {
    if (speakingId === id) {
      ...
      utt.lang = isEs ? "es-ES" : isEn ? "en-US" : "tr-TR";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-emerald-600 to-teal-500", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl font-black text-white mb-4", children: [
      "🔬 ",
      isEs ? "Ciencias" : isEn ? "Science" : "Fen Bilimleri"
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/20 rounded-2xl p-3 mb-4 flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-white text-xs mb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold", children: isEs ? "Progreso en este nivel" : isEn ? "Progress at this level" : "Bu seviyedeki ilerleme" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-white/60 py-8", children: isEs ? "No se encontraron resultados 🔍" : isEn ? "No results found 🔍" : "Sonuç bulunamadı 🔍" }) : filtered.map((item) => {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: speakingId === item.key ? isEs ? "⏹ Parar" : isEn ? "⏹ Stop" : "⏹ Durdur" : isEs ? "🔊 Escuchar" : isEn ? "🔊 Listen" : "🔊 Dinle"
              }
            ),
            ...
            isRead && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-green-300 text-xs font-bold", children: [
              "✅",
              " ",
              isEs ? "Aprendido (+10 pts ganados)" : isEn ? "Learned (+10 pts earned)" : "Öğrenildi (+10 puan kazanıldı)"
            ] })
          ]
        },
        item.key

import { u as useNavigate, a as useLanguage, d as getCurrentUser, r as reactExports, t as trackContentVisit, e as getReadTopics, x as isFavorite, j as jsxRuntimeExports, B as Button, f as updatePoints, y as toggleFavorite, m as markTopicRead, i as incrementDailyContentRead, ae as incrementWeeklyStories } from "./index-C6v58384.js";
import { W as WordDefinitionTooltip } from "./WordDefinitionTooltip-B9OANhCX.js";
const storiesEn = {
  okul_oncesi: [
    {
...
function StoriesPage() {
  ...
  const activeStories = lang === "en" ? storiesEn : lang === "es" ? storiesEs : lang === "fr" ? storiesFr : lang === "zh" ? storiesZh : lang === "hi" ? storiesHi : stories;
  ...
  const handleSpeak = (id, text) => {
    if (speakingId === id) {
      ...
      utt.lang = lang === "en" ? "en-US" : lang === "es" ? "es-ES" : lang === "fr" ? "fr-FR" : lang === "zh" ? "zh-CN" : lang === "hi" ? "hi-IN" : "tr-TR";

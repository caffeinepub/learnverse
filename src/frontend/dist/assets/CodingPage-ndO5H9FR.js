...
function CodingPage() {
  ...
  const codingData = isFr ? codingDataFr : isEn ? codingDataEn : isEs ? codingDataEs : codingDataTr;
  const levelTabs = isFr ? levelTabsFr : isEn ? levelTabsEn : isEs ? levelTabsEs : levelTabsTr;

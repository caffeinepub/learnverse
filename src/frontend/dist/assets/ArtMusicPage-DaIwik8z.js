import { u as useNavigate, a as useLanguage, d as getCurrentUser, r as reactExports, t as trackContentVisit, e as getReadTopics, j as jsxRuntimeExports, B as Button, m as markTopicRead, f as updatePoints, i as incrementDailyContentRead } from "./index-CvFhBtrS.js";
const musicNotesTr = [
  {
    key: "music_do",
    note: "Do",
...
function ArtMusicPage() {
  ...
  const musicNotes = isFr ? musicNotesFr : isEs ? musicNotesEs : isEn ? musicNotesEn : musicNotesTr;
  const artists = isFr ? artistsFr : isEs ? artistsEs : isEn ? artistsEn : artistsTr;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-indigo-500 to-blue-500", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl font-black text-white mb-4", children: [
      "🎵",
      " ",
      isEs ? "Música & Arte" : isFr ? "Musique & Art" : isEn ? "Music & Art" : "Müzik & Sanat"
    ] }),

import { u as useNavigate, a as useLanguage, d as getCurrentUser, r as reactExports, t as trackContentVisit, e as getReadTopics, j as jsxRuntimeExports, m as markTopicRead, f as updatePoints, i as incrementDailyContentRead } from "./index-dncktxyT.js";
...
function ProverbsPage() {
  ...
  const handleSpeak = (id, trText, enText) => {
  ...
  const filteredProverbs = proverbs[level].filter((p) => {
    ...
    const displayTitle = lang === "en" && (enTr == null ? void 0 : enTr.title) ? enTr.title : p.title;
    const displayText = lang === "en" && (enTr == null ? void 0 : enTr.text) ? enTr.text : p.text;
    const displayMeaning = lang === "en" && (enTr == null ? void 0 : enTr.meaning) ? enTr.meaning : p.meaning;
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                onClick: () => handleSpeak(p.key, p.text, enTr == null ? void 0 : enTr.text),

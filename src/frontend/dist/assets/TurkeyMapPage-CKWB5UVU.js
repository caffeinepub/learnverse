import { u as useNavigate, a as useLanguage, d as getCurrentUser, r as reactExports, t as trackContentVisit, e as getReadTopics, j as jsxRuntimeExports, B as Button, m as markTopicRead, f as updatePoints, i as incrementDailyContentRead } from "./index-CJOOPb92.js";
const regions = [
  {
    key: "map_marmara",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-black", children: isEs ? r.nameEs : isEn ? r.nameEn : r.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white/80 text-xs", children: [
                  (isEs ? r.provincesEs : isEn ? r.provincesEn : r.provinces).slice(0, 3).join(", "),
                  "..."
                ] })
              ] }),
    ...
    mode === "quiz" && quizRegion && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/20 rounded-2xl p-4 mb-4 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white/70 text-xs mb-1", children: [
          isEs ? "Puntos" : isEn ? "Score" : "Puan",
          ": ",
          score,
          " |",
          " ",
          isEs ? "Pregunta" : isEn ? "Question" : "Soru",
          ": ",
          quizCount
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: quizChoices.map((choice, cIdx) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: isEs ? choice.nameEs : isEn ? choice.nameEn : choice.name
          },
          choice.key
        );
      }) }),

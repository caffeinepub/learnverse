const contentTranslationsEn = {
  ...
  gr_anlatim: {
    ...
    example: "Wrong: 'I read read the book.' Correct: 'I read the book repeatedly.'"
  },
  gr_ses_olaylar: {
    title: "Sound Changes",
  ...
  gr_cumle_turleri: {
    ...
    example: "Affirmative: She came. Negative: She didn't come. Question: Did she come?"
  },
  gr_paragraf: {
    title: "Paragraph",
    rule: "A unit of text with multiple sentences about one idea.",
    example: "Each paragraph has a main idea. The first sentence introduces the topic."
  },
  // VOCABULARY
  v_mutlu: {
    word: "Happy",
  ...
  v_ambivalans: {
    ...
    example: "She felt ambivalent about the exam result: both excited and scared."
  }
};
const contentTranslationsEs = {
  // PROVERBS
  pr_damla: {
  ...
  gr_paragraf: {
    ...
    example: "Cada párrafo tiene una idea principal. La primera oración introduce el tema."
  },
  // VOCABULARY
  v_mutlu: {
    word: "Feliz",
...
const contentTranslationsFr = {
  ...
  gr_noktalama: {
    ...
    example: "Le point, la virgule, le point d'interrogation, le point d'exclamation."
  },
  gr_edilgen: {
...
export {
  contentTranslationsEn as a,
  contentTranslationsFr as b,
  contentTranslationsEs as c,
  contentTranslationsZh as d,
  contentTranslationsHi as e
};

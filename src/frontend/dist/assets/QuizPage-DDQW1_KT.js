        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-black text-sm", children: lang === "es" ? `${dueCount} pregunta${dueCount > 1 ? "s" : ""} para repasar` : lang === "en" ? `${dueCount} question${dueCount > 1 ? "s" : ""} due for review` : lang === "fr" ? `${dueCount} question${dueCount > 1 ? "s" : ""} à réviser` : `${dueCount} soru tekrar için bekliyor` }),

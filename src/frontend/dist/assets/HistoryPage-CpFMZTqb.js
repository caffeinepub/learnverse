import { u as useNavigate, a as useLanguage, d as getCurrentUser, r as reactExports, t as trackContentVisit, e as getReadTopics, j as jsxRuntimeExports, f as updatePoints, i as incrementDailyContentRead, m as markTopicRead } from "./index-gTagJUnF.js";
import { F as FlashcardMode } from "./FlashcardMode-Bn0HoNX4.js";
import "./proxy-CZ2Tjut2.js";
const historyDataTr = {
  okul_oncesi: [
    {
      key: "hist_ataturk1",
...
function HistoryPage() {
  ...
  const historyData = isZh ? historyDataZh : isEn ? historyDataEn : isEs ? historyDataEs : isFr ? historyDataFr : historyDataTr;
  const levelTabs = isZh ? levelTabsZh : isEn ? levelTabsEn : isEs ? levelTabsEs : isFr ? levelTabsFr : levelTabsTr;
  ...
  const handleSpeak = (id, text) => {
    if (speakingId === id) {
      ...
      utt.lang = isZh ? "zh-CN" : isEn ? "en-US" : isEs ? "es-ES" : isFr ? "fr-FR" : "tr-TR";

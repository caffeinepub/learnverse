import { u as useNavigate, a as useLanguage, d as getCurrentUser, r as reactExports, t as trackContentVisit, e as getReadTopics, j as jsxRuntimeExports, m as markTopicRead, f as updatePoints, i as incrementDailyContentRead } from "./index-DJxeeYpK.js";
import { c as contentTranslationsEs, a as contentTranslationsEn, b as contentTranslationsFr, d as contentTranslationsZh } from "./content-translations-zh-hc9cS5RR.js";
const grammarCards = {
  okul_oncesi: [
    {
      key: "gr_harf_a",
...
function GrammarPage() {
  ...
  const filteredCards = grammarCards[level].filter((c) => {
    ...
    const displayTitle = (tr == null ? void 0 : tr.title) || c.title;
    const displayRule = (tr == null ? void 0 : tr.rule) || c.rule;
  ...
  const pageTitle = lang === "es" ? "Tarjetas de Gramática" : lang === "en" ? "Grammar Cards" : "Dilbilgisi";
  const exLabel = lang === "es" ? "Ejemplo:" : lang === "en" ? "Example:" : "Örnek:";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-teal-500 to-cyan-500", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: filteredCards.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      const displayTitle = (tr == null ? void 0 : tr.title) || c.title;
      const displayRule = (tr == null ? void 0 : tr.rule) || c.rule;
      const displayExample = (tr == null ? void 0 : tr.example) || c.example;
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/10 rounded-xl p-2 mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white/70 text-xs font-bold block mb-1", children: exLabel }),

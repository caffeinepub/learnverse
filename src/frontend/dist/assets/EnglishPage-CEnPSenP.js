import { u as useNavigate, a as useLanguage, d as getCurrentUser, r as reactExports, t as trackContentVisit, e as getReadTopics, j as jsxRuntimeExports, m as markTopicRead, f as updatePoints, i as incrementDailyContentRead } from "./index-C6v58384.js";
const englishDataTr = {
  okul_oncesi: [
    {
      key: "eng_colors",
  ...
  okul_oncesi: [
    {
      ...
      emoji: "🌈",
      title: "颜色 / Colors",
      description: "学习基本颜色：红色、蓝色、黄色、绿色、紫色、橙色 (Red, Blue, Yellow, Green, Purple, Orange)",
    ...
    },
    {
      ...
      emoji: "🔢",
      title: "数字 / Numbers",
      description: "从一数到十：一、二、三、四、五、六、七、八、九、十 (One ~ Ten)",
    ...
    },
    {
      ...
      emoji: "🐶",
      title: "动物 / Animals",
      description: "常见动物：狗、猫、鸟、鱼、兔子、狮子、大象 (Dog, Cat, Bird, Fish, Rabbit)",
    ...
    },
    {
      ...
      emoji: "👨‍👩‍👧",
      title: "家人 / Family",
      description: "家庭成员：妈妈、爸爸、哥哥/弟弟、姐姐/妹妹 (Mother, Father, Brother, Sister)",
    ...
    },
    {
      ...
      emoji: "🥗",
      title: "食物 / Food",
      description: "美味食物：苹果、面包、牛奶、鸡蛋、米饭 (Apple, Bread, Milk, Egg, Rice)",
    ...
    },
    {
      ...
      emoji: "👋",
      title: "问候语 / Greetings",
      description: "打招呼：你好、早上好、再见、谢谢、请 (Hello, Good morning, Goodbye, Thank you, Please)",
      example: "你好！你好吗？我很好，谢谢！(Hello! How are you? I am fine, thank you!)"
    },
    {
      key: "eng_body",
      emoji: "👁️",
      title: "身体 / Body",
      description: "身体部位：眼睛、鼻子、嘴巴、耳朵、手、脚 (Eyes, Nose, Mouth, Ears, Hands, Feet)",
    ...
    },
    {
      ...
      emoji: "☀️",
      title: "天气 / Weather",
      description: "天气词汇：晴天、雨天、多云、下雪 (Sunny, Rainy, Cloudy, Snowy)",
    ...
    },
    {
      ...
      emoji: "🔷",
      title: "形状 / Shapes",
      description: "基本形状：圆形、正方形、三角形、星形 (Circle, Square, Triangle, Star)",
    ...
    },
    {
      ...
      emoji: "👕",
      title: "衣服 / Clothes",
      description: "衣物单词：衬衫、裤子、鞋子、帽子 (Shirt, Pants, Shoes, Hat)",
  ...
  ilkokul: [
    {
      ...
      emoji: "🏫",
      title: "学校 / School",
      description: "学校词汇：老师、学生、书本、黑板、教室 (Teacher, Student, Book, Blackboard, Classroom)",
    ...
    },
    {
      ...
      description: "一周七天：星期一、星期二...星期日 (Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday)",
    ...
    },
    {
      ...
      description: "扩展颜色：粉色、棕色、黑色、白色、灰色 (Pink, Brown, Black, White, Gray)",
      example: "天空是蓝色的，草是绿色的。(The sky is blue, the grass is green.)"
    },
    {
      key: "eng_sentences",
      emoji: "💬",
      title: "简单句子 / Simple Sentences",
      description: "造句基础：主语 + 动词 + 宾语。例如：我 + 爱 + 你。(I + love + you.)",
    ...
    },
    {
      ...
      emoji: "🏃",
      title: "动词 / Verbs",
      description: "常用动词：跑、吃、喝、睡觉、玩、学习 (Run, Eat, Drink, Sleep, Play, Study)",
    ...
    },
    {
      ...
      description: "描述词：大、小、快、慢、热、冷 (Big, Small, Fast, Slow, Hot, Cold)",
    ...
    },
    {
      ...
      emoji: "🏙️",
      title: "地点 / Places",
      description: "常见地点：学校、公园、超市、医院、图书馆 (School, Park, Supermarket, Hospital, Library)",
      example: "我去公园。(I go to the park.) 她在图书馆。(She is in the library.)"
    },
    {
      key: "eng_time",
      emoji: "⏰",
      title: "时间 / Time",
      description: "时间表达：早上、下午、晚上、现在、之前、之后 (Morning, Afternoon, Evening, Now, Before, After)",
    ...
    },
    {
      ...
      description: "提问词：什么、谁、哪里、什么时候、为什么、怎么 (What, Who, Where, When, Why, How)",
      example: "你叫什么名字？(What is your name?) 你住在哪里？(Where do you live?)"
    },
    {
      key: "eng_numbers_adv",
      emoji: "🔢",
      title: "大数字 / Larger Numbers",
      description: "数字扩展：十、二十、五十、一百 (Ten, Twenty, Fifty, One Hundred)",
  ...
  ortaokul: [
    {
      ...
      description: "英语语法：现在时、过去时、将来时 (Present, Past, Future Tense)",
    ...
    },
    {
      ...
      description: "位置介词：在...上面、下面、里面、旁边、前面 (On, Under, In, Next to, In front of)",
      example: "书在桌子上。(The book is on the table.) 猫在沙发下。(The cat is under the sofa.)"
    },
    {
      key: "eng_reading",
      emoji: "📖",
      title: "阅读理解 / Reading",
      description: "阅读技巧：找主题、理解细节、推断含义 (Find the main idea, understand details, infer meaning)",
      example: "先通读全文，再回答问题。(Read the whole text first, then answer questions.)"
    },
    {
      key: "eng_writing",
      emoji: "✍️",
      title: "写作 / Writing",
      description: "写作结构：开头、正文、结尾 (Introduction, Body, Conclusion)",
      example: "好文章有清晰的开头和结尾。(A good essay has a clear beginning and ending.)"
    },
    {
      key: "eng_idioms",
      emoji: "🗣️",
      title: "惯用语 / Idioms",
      description: "常用短语：加油 (Break a leg!)、忙得不可开交 (Busy as a bee)、十分容易 (Piece of cake)",
    ...
    },
    {
      ...
      description: "科技英语：网络、人工智能、软件、应用程序 (Internet, AI, Software, Application)",
    ...
    },
    {
      ...
      description: "环保词汇：气候变化、回收利用、可再生能源 (Climate change, Recycling, Renewable energy)",
    ...
    },
    {
      ...
      description: "观点表达：我认为、在我看来、总的来说 (I think, In my opinion, In conclusion)",
    ...
    },
    {
      ...
      example: "My name is Li Ming. I am 14 years old. I like reading and coding."
    },
    {
      key: "eng_science_vocab",
      emoji: "🔬",
      title: "科学词汇 / Science Vocabulary",
      description: "科学英语：实验、假说、证据、结论 (Experiment, Hypothesis, Evidence, Conclusion)",
      example: "We did an experiment to test our hypothesis. The results showed..."
    }
  ]
};
const levelTabsZh = [
  ...
  okul_oncesi: [
    {
      ...
      emoji: "🌈",
      title: "रंग / Colors",
      description: "मूल रंग सीखें: लाल, नीला, पीला, हरा, बैंगनी, नारंगी (Red, Blue, Yellow, Green, Purple, Orange)",
    ...
    },
    {
      ...
      description: "एक से दस तक गिनें: One, Two, Three, Four, Five, Six, Seven, Eight, Nine, Ten",
    ...
    },
    {
      ...
      emoji: "🐶",
      title: "जानवर / Animals",
      description: "सामान्य जानवर: कुत्ता, बिल्ली, पक्षी, मछली, खरगोश (Dog, Cat, Bird, Fish, Rabbit)",
      example: "कुत्ता 'भौं' करता है। बिल्ली 'म्याऊँ' करती है। (The dog says woof. The cat says meow.)"
    },
    {
      key: "eng_family_hi",
      emoji: "👨‍👩‍👧",
      title: "परिवार / Family",
      description: "परिवार के सदस्य: माँ, पिता, भाई, बहन (Mother, Father, Brother, Sister)",
    ...
    },
    {
      ...
      emoji: "🥗",
      title: "खाना / Food",
      description: "स्वादिष्ट खाना: सेब, रोटी, दूध, अंडा, चावल (Apple, Bread, Milk, Egg, Rice)",
    ...
    },
    {
      ...
      description: "मिलना-जुलना: नमस्ते, सुप्रभात, अलविदा, धन्यवाद, कृपया (Hello, Good morning, Goodbye, Thank you, Please)",
      example: "नमस्ते! आप कैसे हैं? मैं ठीक हूँ, धन्यवाद! (Hello! How are you? I am fine, thank you!)"
    },
    {
      key: "eng_body_hi",
      emoji: "👁️",
      title: "शरीर / Body",
      description: "शरीर के अंग: आँखें, नाक, मुँह, कान, हाथ, पैर (Eyes, Nose, Mouth, Ears, Hands, Feet)",
    ...
    },
    {
      ...
      emoji: "☀️",
      title: "मौसम / Weather",
      description: "मौसम के शब्द: धूपवाला, बरसात, बादलवाला, बर्फीला (Sunny, Rainy, Cloudy, Snowy)",
  ...
  ilkokul: [
    {
      ...
      emoji: "🏫",
      title: "स्कूल / School",
      description: "स्कूल के शब्द: शिक्षक, छात्र, किताब, ब्लैकबोर्ड, कक्षा (Teacher, Student, Book, Blackboard, Classroom)",
    ...
    },
    {
      ...
      description: "सप्ताह के सात दिन: सोमवार, मंगलवार... रविवार (Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday)",
    ...
    },
    {
      ...
      description: "सामान्य क्रियाएँ: दौड़ना, खाना, पीना, सोना, खेलना, पढ़ना (Run, Eat, Drink, Sleep, Play, Study)",
    ...
    },
    {
      ...
      description: "वर्णनात्मक शब्द: बड़ा, छोटा, तेज़, धीमा, गर्म, ठंडा (Big, Small, Fast, Slow, Hot, Cold)",
    ...
    },
    {
      ...
      emoji: "🏙️",
      title: "स्थान / Places",
      description: "सामान्य स्थान: स्कूल, पार्क, बाज़ार, अस्पताल, पुस्तकालय (School, Park, Supermarket, Hospital, Library)",
    ...
    },
    {
      ...
      emoji: "⏰",
      title: "समय / Time",
      description: "समय के शब्द: सुबह, दोपहर, शाम, अभी, पहले, बाद में (Morning, Afternoon, Evening, Now, Before, After)",
    ...
    },
    {
      ...
      description: "प्रश्न पूछना: क्या, कौन, कहाँ, कब, क्यों, कैसे (What, Who, Where, When, Why, How)",
      example: "तुम्हारा नाम क्या है? (What is your name?) तुम कहाँ रहते हो? (Where do you live?)"
    },
    {
      key: "eng_prepositions_hi",
      emoji: "📍",
      title: "पूर्वसर्ग / Prepositions",
      description: "स्थान और दिशा: ऊपर, नीचे, अंदर, बाहर, पास, दूर (On, Under, In, Out, Near, Far)",
      example: "किताब मेज़ पर है। (The book is on the table.) बिल्ली बिस्तर के नीचे है।"
    }
  ],
  ortaokul: [
    {
      ...
      emoji: "⏳",
      title: "काल / Tenses",
      description: "अंग्रेज़ी के तीन मुख्य काल: वर्तमान, भूत और भविष्य (Present, Past, Future Tense)",
    ...
    },
    {
      ...
      example: "If it rains, I will take an umbrella. अगर बारिश हो तो मैं छाता लूँगा।"
    },
    {
      key: "eng_passive_hi",
      emoji: "🔄",
      title: "कर्मवाच्य / Passive Voice",
      description: "Active से Passive voice बनाना: Subject + be + past participle",
    ...
    },
    {
      ...
      description: "निबंध की संरचना: परिचय, मुख्य भाग और निष्कर्ष (Introduction, Body, Conclusion)",
      example: "Introduction: hook + thesis. Body: 3 paragraphs. Conclusion: summary."
    },
    {
      key: "eng_idioms_hi",
      emoji: "🎭",
      ...
      example: "Break a leg = शुभकामनाएँ। It's raining cats and dogs = बहुत तेज़ बारिश।"
    },
    {
      key: "eng_reading_hi",
      emoji: "📖",
      ...
      example: "Main idea: passage का केंद्रीय विषय। Supporting details: उदाहरण और प्रमाण।"
    },
    {
      key: "eng_debate_hi",
      emoji: "🗣️",
    ...
    },
    {
      ...
      description: "कठिन अंग्रेज़ी शब्द और उनके अर्थ: Ambiguous, Benevolent, Contemplate",
      example: "Ambiguous = अस्पष्ट। Benevolent = दयालु। Contemplate = विचार करना।"
    }
  ]
};
const levelTabsHi = [
...
function EnglishPage() {
  ...
  const englishData = isZh ? englishDataZh : isFr ? englishDataFr : isEs ? englishDataEs : isHi ? englishDataHi : isEn ? englishDataEn : englishDataTr;
  const levelTabs = isZh ? levelTabsZh : isFr ? levelTabsFr : isEs ? levelTabsEs : isHi ? levelTabsHi : isEn ? levelTabsEn : levelTabsTr;

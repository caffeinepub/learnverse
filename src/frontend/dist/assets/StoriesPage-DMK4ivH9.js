import { u as useNavigate, a as useLanguage, d as getCurrentUser, r as reactExports, t as trackContentVisit, e as getReadTopics, j as jsxRuntimeExports, B as Button, f as updatePoints, m as markTopicRead, i as incrementDailyContentRead } from "./index-CVbKHV8b.js";
const storiesEn = {
  okul_oncesi: [
    {
...
function StoriesPage() {
  ...
  const activeStories = lang === "en" ? storiesEn : lang === "es" ? storiesEs : stories;
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-white font-black text-lg", children: s.title }),
                isRead && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-green-300 text-xl", children: "✓" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/90 text-sm leading-relaxed mb-4", children: s.text }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",

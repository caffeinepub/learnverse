  ...
  okul_oncesi: [
    {
      ...
      emoji: "🌱",
      title: "पौधे",
      info: "पौधे मिट्टी से पानी और सूरज की रोशनी से बढ़ते हैं। वे हमारे लिए ऑक्सीजन बनाते हैं।",
      fact: "पौधे हमारे लिए ऑक्सीजन बनाते हैं!"
    },
    {
      key: "sci_janvar_hi",
      emoji: "🐾",
      title: "जानवर",
      info: "जानवर जीवित प्राणी हैं। कुछ पालतू होते हैं और कुछ जंगल में रहते हैं।",
      fact: "पृथ्वी पर 80 लाख से अधिक जानवरों की प्रजातियाँ हैं!"
    },
    {
      key: "sci_pani_hi",
      emoji: "💧",
      title: "पानी",
      info: "पानी जीवन के लिए बहुत जरूरी है। मानव शरीर का 60% हिस्सा पानी से बना है।",
      fact: "पानी ठोस, तरल और गैस तीनों रूपों में पाया जाता है।"
    },
    {
      key: "sci_aasman_hi",
      emoji: "🌟",
      title: "आसमान",
      info: "आसमान में सूरज, चाँद, तारे और बादल होते हैं।",
      fact: "चाँद पृथ्वी का एकमात्र प्राकृतिक उपग्रह है।"
    },
    {
      key: "sci_mausam_hi",
      emoji: "🍂",
      title: "मौसम",
      info: "साल में 4 मौसम होते हैं: वसंत, गर्मी, शरद और सर्दी।",
      fact: "मौसम पृथ्वी के झुके हुए घूमने से बनते हैं।"
    },
    {
      key: "sci_rang_hi",
      emoji: "🌈",
      title: "रंग",
      info: "सूरज की रोशनी में 7 रंग छिपे हैं। इन्हें इंद्रधनुष में देखा जा सकता है।",
      fact: "लाल, नीला और पीला मुख्य रंग हैं।"
    },
    {
      key: "sci_mausam2_hi",
      emoji: "🌦️",
      title: "हवा का मौसम",
      info: "दिन धूपवाले, बरसाती, बर्फीले या बादलवाले हो सकते हैं।",
      fact: "तापमान मापने के लिए थर्मामीटर का उपयोग होता है।"
    },
    {
      key: "sci_magnet_hi",
      emoji: "🧲",
      title: "चुंबक",
      info: "चुंबक लोहे की वस्तुओं को खींचता है। इसमें उत्तर और दक्षिण ध्रुव होते हैं।",
      fact: "पृथ्वी खुद एक बड़ा चुंबक है!"
    }
  ],
  ilkokul: [
    {
      ...
      info: "पौधे सूरज की रोशनी से कार्बन डाइऑक्साइड और पानी को भोजन और ऑक्सीजन में बदलते हैं।",
      fact: "प्रकाश संश्लेषण के बिना पृथ्वी पर ऑक्सीजन नहीं होती।"
    },
    {
      key: "sci_padarth_hi",
      emoji: "🔬",
      title: "पदार्थ की अवस्थाएँ",
      info: "पदार्थ ठोस, तरल और गैस अवस्था में होता है। गर्मी से अवस्था बदलती है।",
      fact: "लोहा बहुत अधिक तापमान पर पिघल जाता है।"
    },
    {
      key: "sci_prakash_hi",
      emoji: "💡",
      title: "प्रकाश",
      info: "प्रकाश ऊर्जा का एक रूप है जो आँखों से दिखता है। यह सीधी रेखा में चलता है।",
      fact: "प्रकाश एक सेकंड में 3 लाख किलोमीटर की गति से चलता है।"
    },
    {
      key: "sci_dhwani_hi",
      emoji: "🔊",
      title: "ध्वनि",
      info: "ध्वनि कंपन से बनती है और हवा में अलग-अलग आवृत्तियों पर चलती है।",
      fact: "अंतरिक्ष में ध्वनि नहीं सुनाई देती क्योंकि माध्यम नहीं है।"
    },
    {
      key: "sci_ecology_hi",
      emoji: "🌾",
      title: "पारिस्थितिकी तंत्र",
      info: "किसी क्षेत्र में रहने वाले सभी जीव और निर्जीव तत्व मिलकर पारिस्थितिकी तंत्र बनाते हैं।",
      fact: "जंगलों को पृथ्वी के फेफड़े कहा जाता है।"
    },
    {
      key: "sci_bal_hi",
      emoji: "💪",
      title: "बल",
      info: "बल वस्तुओं को गतिमान करता है। खिंचाव, धक्का और घर्षण बल के उदाहरण हैं।",
      fact: "गुरुत्वाकर्षण बल हमें जमीन पर रखता है।"
    },
    {
      key: "sci_mitti_hi",
      emoji: "🌻",
      title: "मिट्टी",
      info: "मिट्टी चट्टानों के टूटने से बनती है और पौधों के जीवन के लिए जरूरी है।",
      fact: "1 सेंटीमीटर मिट्टी बनने में सैकड़ों साल लगते हैं।"
    }
  ],
  ortaokul: [
    {
      ...
      emoji: "⚛️",
      title: "परमाणु और अणु",
      info: "सभी पदार्थ परमाणुओं से बने हैं। परमाणु मिलकर अणु बनाते हैं जो हमारे चारों ओर सब कुछ बनाते हैं।",
      fact: "एक परमाणु का आकार लगभग एक नैनोमीटर होता है।"
    },
    {
      key: "sci_bijli_hi",
      emoji: "⚡",
      title: "विद्युत",
      info: "विद्युत आवेश के प्रवाह से उत्पन्न ऊर्जा है। हमारी दैनिक जीवन में इसका बहुत उपयोग है।",
      fact: "बिजली की चमक का तापमान 30,000°C तक पहुँचता है।"
    },
    {
      key: "sci_genetics_hi",
      emoji: "🧬",
      title: "आनुवंशिकी",
      info: "आनुवंशिकी यह अध्ययन करती है कि DNA के माध्यम से लक्षण माता-पिता से बच्चों में कैसे जाते हैं।",
      fact: "मानव जीनोम में लगभग 3 अरब base pairs हैं।"
    },
    {
      key: "sci_solarsys_hi",
      emoji: "🌌",
      title: "सौरमंडल",
      info: "सौरमंडल में सूर्य और उसके चारों ओर घूमने वाले आठ ग्रह हैं, जिनमें पृथ्वी भी शामिल है।",
      fact: "सूर्य सौरमंडल के कुल द्रव्यमान का 99.86% है।"
    },
    {
      key: "sci_rasayan_hi",
      emoji: "🧪",
      title: "रासायनिक क्रियाएँ",
      info: "रासायनिक क्रिया वह प्रक्रिया है जिसमें पदार्थ रासायनिक रूप से बदलते हैं और नए पदार्थ बनते हैं।",
      fact: "लोहे में जंग लगना एक धीमी रासायनिक क्रिया है।"
    },
    {
      key: "sci_paryavaran_hi",
      emoji: "♻️",
      title: "पर्यावरण संरक्षण",
      info: "पर्यावरण की रक्षा करना मनुष्यों और पृथ्वी के सभी जीवों के लिए बहुत जरूरी है।",
      fact: "एक प्लास्टिक बैग को प्राकृतिक रूप से नष्ट होने में 450 साल लगते हैं।"
    },
    {
      key: "sci_dimag_hi",
      emoji: "🧠",
      title: "मस्तिष्क और तंत्रिका तंत्र",
      info: "मस्तिष्क मानव शरीर का सबसे जटिल अंग है। तंत्रिका तंत्र पूरे शरीर की अनुभूतियों और गतिविधियों को नियंत्रित करता है।",
      fact: "मानव मस्तिष्क में लगभग 86 अरब तंत्रिका कोशिकाएँ हैं।"
    }
  ]
};
const levelTabsHi = [
...
function SciencePage() {
  ...
  const scienceData = isZh ? scienceDataZh : isFr ? scienceDataFr : isEs ? scienceDataEs : isHi ? scienceDataHi : isEn ? scienceDataEn : scienceDataTr;
  ...
  const handleSpeak = (id, text) => {
    if (speakingId === id) {
      ...
      utt.lang = isZh ? "zh-CN" : isFr ? "fr-FR" : isEs ? "es-ES" : isHi ? "hi-IN" : isEn ? "en-US" : "tr-TR";
